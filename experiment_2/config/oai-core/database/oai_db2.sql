...
('208950000000125', '20895','{\"defaultSingleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}]}'),
('208950000000126', '20895','{\"defaultSingleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}]}'),
('208950000000127', '20895','{\"defaultSingleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}]}'),
('208950000000128', '20895','{\"defaultSingleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}]}'),
('208950000000129', '20895','{\"defaultSingleNssais\": [{\"sst\": 1, \"sd\": \"000001\"}]}');
-- --------------------------------------------------------
...
INSERT INTO `AuthenticationSubscription` (`ueid`, `authenticationMethod`, `encPermanentKey`, `protectionParameterId`, `sequenceNumber`, `authenticationManagementField`, `algorithmId`, `encOpcKey`, `encTopcKey`, `vectorGenerationInHss`, `n5gcAuthMethod`, `rgAuthenticationInd`, `supi`) VALUES
    ('999700000109070', '5G_AKA', 'D9145DA4F999431B268BB056A0AED9E9', 'D9145DA4F999431B268BB056A0AED9E9', '{\"sqn\": \"000000000000\", \"sqnScheme\": \"NON_TIME_BASED\", \"lastIndexes\": {\"ausf\": 0}}', '8000', 'milenage', '044E658D1B1E9040571EFAE1B5C76C1F', NULL, NULL, NULL, NULL, '999700000109070');

INSERT INTO `AuthenticationSubscription` (`ueid`, `authenticationMethod`, `encPermanentKey`, `protectionParameterId`, `sequenceNumber`, `authenticationManagementField`, `algorithmId`, `encOpcKey`, `encTopcKey`, `vectorGenerationInHss`, `n5gcAuthMethod`, `rgAuthenticationInd`, `supi`) VALUES
    ('999700000109071', '5G_AKA', '054D0D1D20F523AB92A4AB0D51674A8E', '054D0D1D20F523AB92A4AB0D51674A8E', '{\"sqn\": \"000000000000\", \"sqnScheme\": \"NON_TIME_BASED\", \"lastIndexes\": {\"ausf\": 0}}', '8000', 'milenage', 'AC7598E39DE506C51030922ABD0F6D9E', NULL, NULL, NULL, NULL, '999700000109071');

INSERT INTO `AuthenticationSubscription` (`ueid`, `authenticationMethod`, `encPermanentKey`, `protectionParameterId`, `sequenceNumber`, `authenticationManagementField`, `algorithmId`, `encOpcKey`, `encTopcKey`, `vectorGenerationInHss`, `n5gcAuthMethod`, `rgAuthenticationInd`, `supi`) VALUES
    ('999700000109072', '5G_AKA', '216011D9480E3B3574D91A60FC0C81FB', '216011D9480E3B3574D91A60FC0C81FB', '{\"sqn\": \"000000000000\", \"sqnScheme\": \"NON_TIME_BASED\", \"lastIndexes\": {\"ausf\": 0}}', '8000', 'milenage', 'EEB70842315EF217B4CD9490018A26D7', NULL, NULL, NULL, NULL, '999700000109072');

INSERT INTO `AuthenticationSubscription` (`ueid`, `authenticationMethod`, `encPermanentKey`, `protectionParameterId`, `sequenceNumber`, `authenticationManagementField`, `algorithmId`, `encOpcKey`, `encTopcKey`, `vectorGenerationInHss`, `n5gcAuthMethod`, `rgAuthenticationInd`, `supi`) VALUES
    ('999700000109073', '5G_AKA', '9343A0DE665BCBBA504BF1ACF6D8DCAF', '9343A0DE665BCBBA504BF1ACF6D8DCAF', '{\"sqn\": \"000000000000\", \"sqnScheme\": \"NON_TIME_BASED\", \"lastIndexes\": {\"ausf\": 0}}', '8000', 'milenage', '3B3144C6D19DDC0EEEA8CF28CB361E74', NULL, NULL, NULL, NULL, '999700000109073');
...
('999700000109070',
 ...
 '{\"oai\":{
      ...
      \"5gQosProfile\": {
          \"5qi\": 6,
          \"arp\":{\"priorityLevel\": 15,\"preemptCap\": \"NOT_PREEMPT\",\"preemptVuln\":\"PREEMPTABLE\"},
          \"priorityLevel\":1
        },
      \"sessionAmbr\":{\"uplink\":\"1000Mbps\",\"downlink\":\"30Mbps\"},
      \"staticIpAddress\":[{\"ipv4Addr\": \"10.0.0.5\"}]
    }
  }'
);
INSERT INTO `SessionManagementSubscriptionData` (`ueid`, `servingPlmnid`, `singleNssai`, `dnnConfigurations`) VALUES
('999700000109071',
 ...
 '{\"oai\":{
      ...
      \"sessionAmbr\":{\"uplink\":\"1000Mbps\",\"downlink\":\"30Mbps\"},
      \"staticIpAddress\":[{\"ipv4Addr\": \"10.0.0.6\"}]
    }
  }'
);
INSERT INTO `SessionManagementSubscriptionData` (`ueid`, `servingPlmnid`, `singleNssai`, `dnnConfigurations`) VALUES
('999700000109072',
 ...
 '{\"oai\":{
      ...
      \"sessionAmbr\":{\"uplink\":\"1000Mbps\",\"downlink\":\"30Mbps\"},
      \"staticIpAddress\":[{\"ipv4Addr\": \"10.0.0.7\"}]
    }
  }'
);
INSERT INTO `SessionManagementSubscriptionData` (`ueid`, `servingPlmnid`, `singleNssai`, `dnnConfigurations`) VALUES
('999700000109073',
 ...
 '{\"oai\":{
      ...
      \"sessionAmbr\":{\"uplink\":\"1000Mbps\",\"downlink\":\"30Mbps\"},
      \"staticIpAddress\":[{\"ipv4Addr\": \"10.0.0.8\"}]
    }
  }'
);
